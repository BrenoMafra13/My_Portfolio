    ...
    <section id="about" className="reveal scroll-mt-28">
      <div className="flex flex-col gap-4">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          <article
            className="reveal group relative overflow-hidden rounded-3xl border border-line bg-surface p-7 shadow-soft transition hover:-translate-y-1"
          ...
          >
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              ...
              <a
                href="/Breno_Software_Developer_Resume.pdf"
                download
                className="inline-flex items-center justify-center rounded-full border border-line px-5 py-2.5 text-sm font-semibold text-text transition hover:-translate-y-0.5 hover:border-accent"
              >
                Download
              </a>
            </div>
